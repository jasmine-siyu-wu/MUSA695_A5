---
title: "Driving Change: A Call to Action for State BMVs to Uncover and Overcome Hidden Roadblocks in Youth Driver Education"
...
A consequent study by Dong et al. highlights the stark reality: teens like Jasmine in DTDs have a 25% lower likelihood of receiving driver training and securing a license before 18 compared to their peers like Lucas. 

<br>

The impact of these disparities goes beyond mere inconvenience. Transportation safety is tied to driver education and training, with data showing lower crash rates among those who receive early licensure following formal training (cite Walshe). For teens living in DTDs, the lack of access is not just about mobility; it is a safety risk and a hindrance to equal opportunities in education and employment. 
